...
import 'package:e_complaint_app/views/screens/riwayat_aduan/components/comment.dart';
...
class _AduanCardState extends State<AduanCard> {
  ...
  Future<void> _loadLikeStatus() async {
    ...
    bool isLiked = prefs.getBool('like_status_${widget.id}') ?? false;
    setState(() {
      _isLiked = isLiked;
    });
    _fetchInitialData(isLiked);
  }

  Future<void> _saveLikeStatus() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setBool('like_status_${widget.id}', _isLiked);
  }
  ...
  void _fetchInitialData(bool isLikedFromPrefs) async {
    try {
